  ...
  return (
    <section className="grid gap-8 pb-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
      <SectionHeading
        ...
        description="The public portal surfaces published IEEE CS events with concise metadata, searchable categories, and a review-first publishing flow behind the scenes."
      />
      ...
      <div className="rounded-[32px] border border-border/60 bg-card/90 p-6 shadow-[0_24px_80px_-48px_rgba(15,95,85,0.5)]">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Button asChild variant="outline">
            <Link href="/admin/uploads">Open Admin Flow</Link>
          </Button>
        </div>
      </div>
    </section>
